        ...
        <article ref={(el) => (tabRefs.current[1] = el)} className={styles.About}>
            ...
            <div className={styles.container}>
                <div className={`${styles.item} ${styles.left}`}>
                    ...
                    <p>안녕하세요, 프론트엔드 개발자 <span>하진희</span>입니다.😊</p>
                    <p>
                        저는 개발하는 것을 좋아하고 잘하고 싶다는 욕심이 강합니다. 그렇기 때문에 조금이라도 어제보다 더 성장한 개발자가 되기 위해, 매일 부단히 노력 중입니다. <span>그 과정 속에서 새롭게 배운 것들이 있다면</span> 단순히 머리로 기억하는 것이 아니라 <span>블로그와 노션, 깃허브를 사용해 꾸준히 기록</span>해나가고 있습니다.
                    </p>
                    <br />
                    <p>
                        독학으로 공부해왔기 때문에 <span>철저한 자기 관리 속에서 스스로 동기부여를 받아 주체적으로 공부할 것을 찾아 하는 편</span>입니다. 주로 인터넷 강의를 들으면서 프로젝트 단위로 만들면서 배우는 편입니다. 또한 사이드 프로젝트 중에는 좀 더 좋은 UI/UX를 제공하기 위해 <span>계속해서 수정하고 개선</span>해나가는 조금 완벽 주의 성향을 가지고 있습니다.
                    </p>
                    <h3>Interest</h3>
